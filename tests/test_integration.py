...
class TestDataCompatibility:
    ...
    def test_small_dataset(self):
        ...
        with patch('spe9_geomodeling.spe9_toolkit.load_spe9_data', return_value=small_data):
            toolkit = SPE9Toolkit()
            toolkit.load_data()
    ...
    def test_large_dataset_simulation(self):
        ...
        with patch('spe9_geomodeling.spe9_toolkit.load_spe9_data', return_value=large_data):
            toolkit = SPE9Toolkit()
            toolkit.load_data()
            grid_data = toolkit.prepare_features()
    ...
    def test_missing_properties(self):
        ...
        with patch('spe9_geomodeling.spe9_toolkit.load_spe9_data', return_value=incomplete_data):
            toolkit = SPE9Toolkit()
            data = toolkit.load_data()
...
class TestCrossCompatibility:
    ...
    @patch('spe9_geomodeling.spe9_toolkit.load_spe9_data')
    @patch('spe9_geomodeling.unified_toolkit.load_spe9_data')
    def test_toolkit_interoperability(self, mock_unified_load, mock_spe9_load, sample_grdecl_data):
    ...
    def test_plotter_with_toolkit_results(self, sample_grdecl_data):
        ...
        with patch('spe9_geomodeling.spe9_toolkit.load_spe9_data', return_value=sample_grdecl_data):
            toolkit = SPE9Toolkit()
            toolkit.load_data()
            grid_data = toolkit.prepare_features()
